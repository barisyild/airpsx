...
class Const {
    ...
    public static #if orbis inline #end var HTTP_PORT:Int = 1214;
    public static #if orbis inline #end var SYSTEM_APP_DB_PATH = "/system_data/priv/mms/app.db";
    public static #if orbis inline #end var SCRIPT_DB_PATH = '${SCRIPT_PATH}/database.db';
    public static #if orbis inline #end var USER_HOME_PATH:String = "/user/home";
